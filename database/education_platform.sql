...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 23 2025 г., 10:27
...
CREATE TABLE `categories` (
  ...
  `exist` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
...
CREATE TABLE `courses` (
  ...
  `appl` enum('1','0') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `access` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 1, 'Английский язык #1', 'English is main language in USA, UK, AU.', 'english_language.png', 12, 14, '{\"1\": \"json_encode\", \"2\": \"test\", \"firstitem\": 1}', '{}', '1', '1', '2024-12-14 06:18:39', '2025-01-23 03:29:56'),
...
(4, 1, 'Испанский язык', 'Todo el mundo sabe lo que tiene, pero nadie sabe lo que eso vale.', 'spain.png', 12, 5, NULL, NULL, '0', '1', '2024-12-14 10:51:05', '2025-01-23 03:46:38'),
(5, 1, 'Немецкий язык', 'Sieben, Sieben\r\nAi lyu lyu\r\nSieben, Sieben\r\nEin, zwei\r\nSieben, Sieben\r\nAi lyu lyu\r\nEin, zwei, drei', '', 12, 7, NULL, NULL, '0', '1', '2024-12-14 10:51:05', '2025-01-23 04:09:04'),
...
(17, 4, 'C#', 'Base of C# programming language', 'c-sharp.png', 12, 0, NULL, NULL, '1', '1', NULL, '2025-01-23 03:36:03'),
(18, 4, 'C#', 'Base of C# programming language', 'c-sharp.png', 12, 0, NULL, NULL, '1', '0', NULL, '2025-01-23 03:35:47'),
...
CREATE TABLE `course_applications` (
  ...
  `wish_access` enum('1','0') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` enum('Отправлена','Принята','Отклонена') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Отправлена',
...
(24, 1, 'Название урока', '[{\"txt\":\"\\u0417\\u0434\\u0435\\u0441\\u044c \\u043c\\u043e\\u0436\\u0435\\u0442 \\u043d\\u0430\\u0445\\u043e\\u0434\\u0438\\u0442\\u0441\\u044f \\u0442\\u0435\\u043a\\u0441\\u0442 \\u043b\\u044e\\u0431\\u043e\\u0433\\u043e \\u0431\\u043b\\u043e\\u043a\\u0430 \\u0438\\u0437 \\u0443\\u0440\\u043e\\u043a\\u043e\\u0432\"},{\"img\":\"articles-1024x576.png\"},{\"txt\":\"\\u0422\\u0430\\u043a \\u0432\\u044b\\u0433\\u043b\\u044f\\u0434\\u0438\\u0442 \\u0435\\u0449\\u0435 \\u043e\\u0434\\u0438\\u043d \\u0431\\u043b\\u043e\\u043a \\u0441 \\u043a\\u043e\\u043d\\u0442\\u0435\\u043d\\u0442\\u043e\\u043c \\u0443\\u0440\\u043e\\u043a\\u0430\"}]', '', '2025-01-31 12:06:56', NULL, NULL, NULL),
(25, 5, 'Урок №2', '[{\"txt\":\"\\u0417\\u0434\\u0435\\u0441\\u044c \\u043c\\u043e\\u0436\\u0435\\u0442 \\u0431\\u044b\\u0442\\u044c \\u0437\\u0430\\u0433\\u043e\\u043b\\u043e\\u0432\\u043e\\u043a \\u0438\\u043b\\u0438 \\u043f\\u0430\\u0440\\u0430\\u0433\\u0440\\u0430\\u0444\"},{\"img\":\"imya-syshchestvitelnoe.jpg\"},{\"txt\":\"\\u0414\\u043e\\u043f\\u0443\\u0441\\u0442\\u0438\\u043c, \\u0432\\u0442\\u043e\\u0440\\u043e\\u0439 \\u043f\\u0430\\u0440\\u0430\\u0433\\u0440\\u0430\\u0444.\"},{\"img\":\"articles-1024x576.png\"},{\"txt\":\"\\u0418...\\u0415\\u0449\\u0435 \\u043f\\u0430\\u0440\\u0430\\u0433\\u0440\\u0430\\u0444!!!\"}]', '', '2025-01-31 00:00:00', NULL, NULL, NULL),
(26, 1, 'Заголовок №3', '[{\"txt\":\"Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text Some text\"},{\"img\":\"articles-1024x576.png\"},{\"img\":\"articles-1024x576.png\"},{\"img\":\"articles-1024x576.png\"},{\"txt\":\"\\u0414\\u043b\\u0438\\u043d\\u0430 \\u0442\\u0435\\u043a\\u0441\\u0442\\u043e\\u0432\\u043e\\u0433\\u043e \\u043f\\u043e\\u043b\\u044f \\u043c\\u0438\\u043d\\u0438\\u043c\\u0443\\u043c 10 \\u0441\\u0438\\u043c\\u0432\\u043b\\u043e\\u0432\"}]', '', '2025-01-24 00:00:00', NULL, NULL, NULL),
(27, 1, 'Лессон №2', '{\"1\":{\"img\":\"articles-1024x576.png\"},\"2\":{\"txt\":\"\\u0439\\u0446\\u0448\\u043e\\u0440\\u043c\\u043b\\u0434\\u043b\\u043e\\u0440\\u0430\\u043f\\u043b\\u0434\\u0442\\u044c\\u0438\\u043b\\u0434\\u0436\\u044d\"}}', '', '2025-01-25 00:00:00', NULL, NULL, NULL);
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','student','author') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'student',
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `all_courses` json DEFAULT NULL,
  `completed_courses` json DEFAULT NULL,
  `blocked` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(10, 'trapbed', 'trapbed@mail.ru', 'admin', '$2a$12$gcBRwBZw6pES7JRs7tbZG.bM2yU4XGFcogG17is6oXCSqEMQ68aY6', NULL, NULL, '0', '2024-12-13 22:53:42', '2025-01-23 03:36:36'),
...
(16, 'johnjohn', 'john@mail.ru', 'student', '$2y$10$TT0GglDJ2/y87ijb6vIIJ.f/niUdedDDdMHE0SZCxHNRUc6r.q4Fe', '{\"courses\": [1, 4, 5]}', '{\"courses\": [\"1\"]}', '0', '2025-01-23 03:29:10', '2025-01-23 04:09:04');
...
CREATE TABLE `user_applications` (
  ...
  `current_status` enum('student','admin','author') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date` datetime NOT NULL,
  `status_appl` enum('Отправлена','Принята','Отклонена') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `wish_status` enum('admin','author') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
